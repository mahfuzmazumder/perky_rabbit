        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="mt-4" method="POST" action="{{ route('product_create') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-7">
                                    ...
                                    <select class="select2 form-control form-select" name="product_unit_id">
                                        ...
                                        @foreach ($product_units as $product_unit)
                                            <option value="{{ $product_unit->id }}"
                                                @if (old('product_unit_id') == $product_unit->id) selected @endif> {{ $product_unit->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="select2 form-control form-select" name="product_type_id">
                                        ...
                                        @foreach ($product_types as $product_type)
                                            <option value="{{ $product_type->id }}"
                                                @if (old('product_type_id') == $product_type->id) selected @endif> {{ $product_type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                               ...
                               <div class="form-group {{ $errors->has('sale_price') ? 'error' : '' }}">
                                ...
                                <div class="form-group {{ $errors->has('product_description') ? 'error' : '' }}">
                                    ...
                                    <textarea class="form-control" name="product_description" value="{{ old('product_description') }}" placeholder="@lang('common.enter_product_description')"></textarea>
                                    ...
                                    <fieldset class="controls">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <input type="radio" value="0"
                                                {{ old('status') == '0' ? 'checked' : '' }} name="status" id=""
